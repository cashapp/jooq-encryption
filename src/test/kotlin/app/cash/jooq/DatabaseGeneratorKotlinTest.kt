 ...
 * the [EncryptionAwareKotlinGenerator] code generator.
 ...
 *
 * When this test runs, it'll write the generated code into the `jooq-generated-kotlin` directory.
 ...
 */
internal class DatabaseGeneratorKotlinTest {
    ...
    val config = Configuration()
      .withGenerator(
        Generator()
          .withTarget(
            Target()
              .withDirectory("jooq-generated-kotlin")
          ...
          .withName("app.cash.jooq.EncryptionAwareKotlinGenerator")
          .withDatabase(
            Database()
